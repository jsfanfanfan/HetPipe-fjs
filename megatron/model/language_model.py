...
class TransformerLanguageModel(MegatronModule):
    ...
    def __init__(self,
        ...
        self.partition_vector = list(map(int,args.partition_vector.split(",")))
    ...
    def forward(self, enc_input_ids, enc_position_ids, enc_attn_mask,
                ...
                enc_hidden_states=None, output_enc_hidden=False, recompute=False):
        ...
        if enc_hidden_states is None:
            encoder_output = self.encoder(encoder_input,
                                          ...
                                          get_key_value=get_key_value,recompute=recompute)
        else:
        ...
        decoder_output = self.decoder(dec_embedding_output,
                                      ...
                                      enc_dec_attn_mask=enc_dec_attn_mask,recompute=False)
