...
def _add_logging_args(parser):
    ...
    group.add_argument('--log_dir', type=str,
                       help='The path of saving profiler log')
...
def _add_initialization_args(parser):
    ...
    group.add_argument('--task_name', type=str, default="Bert_on_SQuAd",
                       help='the type of task default Bert_on_SQuAd')
    return parser
...
def _add_distributed_args(parser):
    ...
    group.add_argument('--partition_vector', type=str, default="3,3,9,9", 
                        help="the partition of transformers for pipeline-model-parallel")
    group.add_argument('--sprecompute', type=bool, default=False, 
                        help="speed up recompute")
    group.add_argument('--hetpipe', type=bool, default=False, 
                    help="using hetpipe")
    return parser
...
def _add_data_args(parser):
    ...
    group.add_argument('--cache-dir', nargs='*', default=None,
                       help='SquAd cache_dir')
